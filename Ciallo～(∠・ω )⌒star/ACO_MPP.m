function [R_best,F_best,L_best,T_best,S_best,S_ave,Shortest_Route,Shortest_Length] = ACO_MPP(D,initial,destination,dis,h,NC_max,m,t,Rho,Omega,Mu,Lambda,Q )
%%  蚁群算法的路径规划问题求解函数
%%  主要符号说明
%%  D        8方向距离转移矩阵
%%  initial  初始坐标
...
S_ave=zeros(NC_max,1);        %各代路线的平均综合指标
...
%% 第六步：输出结果
Pos=find(S_best==min(S_best));      %找到S_best中最小值所在的位置并赋给Pos
